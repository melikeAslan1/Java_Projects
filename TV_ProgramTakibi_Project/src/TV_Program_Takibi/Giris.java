...
public class Giris extends javax.swing.JFrame {
     ...
     */
    static Kullanici oAndaBagliOlan = null;
    //   static Yönetici oAndaBagliOlanYönetici=null;
    String a;
    ...
    public Giris() {
        ...
        Yönetici y1 = new Yönetici("Ayşe", "99");
        Yönetici y2 = new Yönetici("Fatma", "99");
        Kullanici.kullanicilar.add(k1);
        Kullanici.kullanicilar.add(k2);
        Kullanici.kullanicilar.add(k3);
        Yönetici.yöneticiler.add(y2);
        Yönetici.yöneticiler.add(y1);
    ...
    private void kullaniciGirisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kullaniciGirisActionPerformed
        ...
        for (Kullanici k : Kullanici.kullanicilar) {
            if (k.ad_soyad.equals(jTextField1.getText())&& k.sifre.equals(jTextField2.getText())) {
                ...
                Program_Ara pa = new Program_Ara(k,jTextField1.getText(), jTextField2.getText());
                pa.setVisible(true);
    ...
    private void yoneticiGirisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yoneticiGirisActionPerformed
        // TODO add your handling code here:
         boolean kullaniciGirisBasariliMi=false;
        for (Yönetici k : Yönetici.yöneticiler) {
